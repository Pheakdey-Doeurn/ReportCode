...
<footer class=" site-footer">
											...
											<div class="row justify-content-evenly">
												<div class="col-md-12 col-xl-5 col-lg-4 col-sm-8 footer-col-4">
													<div class="widget">
														...
														<p class="text-capitalize m-b20">Lorem Ipsum is simply dummy text of the printing
															and
														...
														<ul class="list-inline m-a0">
															...
															<li><a href="javascript:void(0);" class="site-button telegram circle " style="background-color:#0077b6;"><i class="fab fa-telegram"></i></a></li>
														</ul>
													</div>
												</div>
												...
												<div class="col-md-6 col-xl-3 col-lg-3 col-sm-6 footer-col-4">
													<div class="widget widget_getintuch">
														...
														<ul>
															<li><i class="ti-location-pin"></i><strong>Address</strong>Kouk Kdouch, Tapoung,
																Battambang, Cambodia</li>
															<li><i class="ti-mobile"></i><strong>Phone</strong>097 6058 985
															</li>
									...
									<div class="footer-bottom">
										<div class="container">
											<div class="row">
												<div class="col-md-6 col-sm-6 text-left "> <span>Copyright © 2024 <strong style="color:antiquewhite;">Thmar Koul Buddhist Secondary School.</strong> All Rights Reserved</span> </div>												
											</div>
										</div>
									</div>
									</footer>
