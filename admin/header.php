            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color" >
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link <?= $page == 'pslide.php' || $page == 'post_donate.php' || $page == 'post-create.php' || $page == 'post-image-action.php' || $page == 'update_image_ss.php' || $page == 'post_update_donate.php' ? 'menu-active' : '' ?>"><i class="flaticon-books"></i><span>Post</span></a>
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="post-create.php" class="nav-link <?= $page == 'post-create.php'|| $page == 'update_image_ss.php' ? 'menu-active' : '' ?>"><i class="fas fa-angle-right"></i>Add Image SS</a>
                                </li>
                                <li class="nav-item">
                                    <a href="post_donate.php" class="nav-link <?= $page == 'post_donate.php' || $page == 'post_update_donate.php' ? 'menu-active' : '' ?>"><i class="fas fa-angle-right"></i>Image Donate QR</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="User-Teacher-Student.php" class="nav-link"><i class="fas fa-angle-right"></i>User Teachers | Students</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
