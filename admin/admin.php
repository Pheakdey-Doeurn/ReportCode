                    ...
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
                            <div class="admin-title">
                                <h5 class="item-title"><?php echo $_SESSION["username"]; ?></h5>
                                <span>Admin</span>
                            </div>
                            <div class="admin-img">
        ...
        <div class="dashboard-page-one">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
                <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="admin.php"><img src="img/logo1.png" alt="logo"></a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="exam-grade.html" class="nav-link"><i class="fas fa-angle-right"></i>User Teachers | Students</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="dashboard-content-one">
                ...
                <footer class="footer-wrap-layout1">
                    <div class="copyright">© Copyrights <a href="#">TKBS</a> 2024. All rights reserved. Designed by <a href="#">TKBS</a></div>
                </footer>
